...
* Exercício: TP05Q04ClassOrdenacaoPorSelecaoRecursiva
*/
...
class Lista
{
	...
	private void ordenacaoNome(int tamanho)
	{
		for(int i = tamanho; i < (n-1); i++)
		{
			...
			for(int j = (i+1); j < n; j++)
			{
				if(lista[menor].getnome().compareTo(lista[j].getnome()) >= 1)
				{
					menor = j;
				}//end if
			}//end for
	 ...
	 * Chamador recursivo
	 */
	public void ordenacaoPorSelecao()
	{
		ordenacaoPorSelecao(0);
	}//end ordenacaoPorSelecao

	/**
	 * Metodo de ordenação por pais de origem
	 */
	public void ordenacaoPorSelecao(int i)
	{
		if(i < (n-1))
		{
			ordenacaoNome(i);
			...
			for(int j = (i+1); j < n; j++)
			{
				if(lista[menor].getpais_origem().trim().compareTo(lista[j].getpais_origem().trim()) >= 1)
				{
					menor = j;
				}//end if
...
class TP05Q04ClassOrdenacaoPorSelecaoRecursiva
{
	/**
	 * Método main
	 */
	...
	//---------------------------------------------------------------------------------
		...
		lista.ordenacaoPorSelecao();
		lista.mostrar();
	//--------------------------------------------------------------------------------
		long fim = System.currentTimeMillis();

		Arq.openWrite("541488_selecaoRecursiva.txt");
		Arq.println("541488\t" + (fim-inicio) + "ms\t" + lista.getcomparacoes());
		Arq.close();
	}//end main
}//end TP05Q02ClassPesquisaBinaria
