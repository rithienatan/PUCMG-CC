...
public:
    ...
    void setupTransform(const mat4 &transform, const vec3 &pos, const vec3 &dir, Boid &boid) {
        ...
        boid.transformCache = boidTransform;
        
        boid.transformWingLeftCache = boidTransform * translate(-0.25f,0.0f,0.0f) * zRotate(DEG2RAD(-20.0f));
        
        boid.transformWingRightCache = boidTransform * translate(0.25f,0.0f,0.0f) * zRotate(DEG2RAD(20.0f));
        
    }
    
    void drawTransform(const Boid &boid) {
        ...
        app->drawPrimitive(GL_QUADS,boid.transformCache,bodyVBuffer, bodyCBuffer, 8 );
        ...
        app->drawPrimitive(GL_TRIANGLES,boid.transformCache,headVBuffer, headCBuffer, 3 );
        ...
        app->drawPrimitive(GL_TRIANGLES,boid.transformWingRightCache,wingVBuffer, wingCBuffer, 3 );
        app->drawPrimitive(GL_TRIANGLES,boid.transformWingLeftCache,&wingVBuffer[3], &wingCBuffer[3], 3 );
    }
};
