 ...
 */
   ...
   // executar o metodo auxiliar
      ...
      IO.println ( " Fibonacci = " + funcao04 ( 6 ) );
      IO.println ( " Fibonacci = " + funcao04 ( 8 ) );
      IO.println ( " Fibonacci = " + funcao04 ( 10 ) );
   // encerrar
      IO.pause ( "Apertar ENTER para terminar." );
   } // fim main( )
} // fim class Exemplo0109