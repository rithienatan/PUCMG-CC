...
{   
   ...
   public static boolean existe( int [ ] tabela , int n )
   {
      boolean resposta = false;
      int tamanho;
      int x;
      ...
      else
      {
         ...
         else
         {
            ...
            for( x = 0; x < tamanho; x = x + 1 )
            {
               ...
               {
                  resposta = true;
                  IO.println( "Número procurado: "+tabela [ x ] );
                  IO.println( "Está na posicão"+x );
                  contador = contador + 1;
               }
            }
            IO.println( "O número foi achado: "+contador );
         }
      }
      return ( resposta );
   }
   ...
   public static void executar( )
   {
      ...
      int n = IO.readint( "Número que você quer procurar no Arranjo: " );
      ...
      else
      {
         ...
         else
         {
            ...
            if( existe( tabela1, n ) )
            {
               IO.println( "Número existe!" );
            }
            else
            {
               IO.println( "Não existe!" );
            }
         }
      }
   }
