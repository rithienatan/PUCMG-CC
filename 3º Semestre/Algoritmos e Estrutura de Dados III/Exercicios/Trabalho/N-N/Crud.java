...
public class Crud {
	...
	private static RandomAccessFile actor;
	private static RandomAccessFile staff;
	...
	public static void main(String[] args) {
		...
		try{
			...
			actor = new RandomAccessFile("atores.db","rw");
			staff = new RandomAccessFile("elenco.db","rw");
