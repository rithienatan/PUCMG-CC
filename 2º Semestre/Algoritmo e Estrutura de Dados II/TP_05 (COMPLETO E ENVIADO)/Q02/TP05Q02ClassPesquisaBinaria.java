...
* Exercício: TP05Q02ClassPesquisaBinaria
*/
...
class Lista
{
	...
	public boolean pesquisaBinaria(String nome)
	{
		...
		while(esq <= dir)
		{
			...
			//System.out.println(lista[meio].getnome());
			int x = nome.compareTo(lista[meio].getnome());
...
class TP05Q02ClassPesquisaBinaria
{
	/**
	 * Método main
	 */
	...
	//---------------------------------------------------------------------------------
		...
		do
		{
			...
			{
				if(lista.pesquisaBinaria(arq[quantEntrada]) == true)
				{
	...
	//--------------------------------------------------------------------------------
		...
		Arq.openWrite("541488_binaria.txt");
