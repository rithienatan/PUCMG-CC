 ...
 */
   ...
   // 3. testar as definicoes de arranjo
      ...
      else
      {
         if ( a1.hasErro ( ) )
         {
            IO.println ( "Contato a3 com erro " + a1.getErro ( ) );
         }
         else
         {
            IO.println ( "Contato a3 nao nulo com "+a1.nome+" e " + a1.fone );
         } // fim se
      } // fim se
      if ( a2 == null )
      {
      ...
      else
      {
         if ( a2.hasErro ( ) )
         {
            IO.println ( "Contato a3 com erro " + a2.getErro ( ) );
         }
         else
         {
            IO.println ( "Contato a3 nao nulo com "+a2.nome+" e " + a2.fone );
         } // fim se      
      } // fim se
      if ( a3 == null )
      {
 ...
 */
   ...
   // criar e executar o metodo auxiliar
      Exemplo0224 m1 = new Exemplo0224 ( );
      m1.metodo04 ( );
   // encerrar
      IO.pause ( "Apertar ENTER para terminar." );
   } // fim main( )
} // fim class Exemplo0224