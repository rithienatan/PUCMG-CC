 ...
 */
public class Guia0028 extends Robot
{
/**
 * construtor padrao da classe Guia0028.
 ...
 */
   public Guia0028( int avenue, int street, int direction, int beepers )
   {
 ...
 */
   ...
   // definir o objeto particular para executar as acoes (agente)
      Guia0028 JK = new Guia0028( 1, 1, NORTH, 0 );
