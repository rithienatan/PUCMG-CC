...
* Exercício: TP05Q05ClassOrdenacaoPorInserção
*/
...
class Lista
{
	 ...
	 */
	public void ordenacaoPorInsercao()
	{
		for(int i = 1; i < n; i++)
		{
			ordenacaoNome(i-1);
...
class TP05Q05ClassOrdenacaoPorInsercao
{
	/**
	 * Método main
	 */
...
}//end TP05Q05ClassOrdenacaoPorInsercao
