...
class Categoria
{
   ...
   */
  public Categoria()
  {this(-1, " ");}//end construtor padrão

  /**
   * Construtor alternativo
   * @param idCategoria,nome
...
class ArquivoCategorias
{
  private RandomAccessFile arqCategoria;
   ...
   */
  public ArquivoCategorias(Categoria cat, String nomeArq,
                         String nomeInd) throws IOException
  {
    ...
    this.categoria = cat;
    this.arqCategoria = new RandomAccessFile(this.nomeArquivo, "rw");
    this.indice = new Indice(20, nomeInd);
    if(arqCategoria.length() < 4)
    {
        arqCategoria.writeInt(0);
    }//end if
  }//end ArquivoCategorias()

  /**
   * Inseri no arquivo de categoria e no indice
   * @param pro Recebe o ponteiro de uma categoria em especifico
   * @return Retorna o id da categoria
   */
  public int incluir(Categoria pro) throws IOException
  {
    arqCategoria.seek(0);
    int lastID = arqCategoria.readInt();
    arqCategoria.seek(0);
    arqCategoria.writeInt(lastID+1);
    pro.setidCategoria(lastID+1);

    arqCategoria.seek(arqCategoria.length());
    long endereco = arqCategoria.getFilePointer();
    byte[] b = pro.toByteArray();
    arqCategoria.writeByte(' ');
    arqCategoria.writeShort(b.length);
    arqCategoria.write(b);
    indice.inserir(pro.getidCategoria(), endereco);

    this.list.add(pro);

    return(pro.getidCategoria());
  }//end incluir

  /**
   * Inseri no arquivo de categoria e no indice sem alterar ID
   * @param pro Recebe o ponteiro de um categoria em especifico
   * @return Retorna o id da categoria
   */
  public int incluirSemAlterarID(Categoria pro) throws IOException
  {
    arqCategoria.seek(0);
    int mainID = arqCategoria.readInt();
    arqCategoria.seek(0);
    arqCategoria.writeInt(mainID);
    pro.setidCategoria(mainID);
    ...
    {
      if(this.list.get(i).getidCategoria() == mainID)
      {
        this.list.remove(i);
        this.list.add(pro);
        i = this.list.size();
   ...
   * @param id Recebe o ponteiro de uma categoria em especifico
   * @return Retorna o endereço de mémoria da categoria em especifico
   */
  public Categoria ler(int id) throws IOException
  {
    ...
    if(endereco != -1)
    {
        arqCategoria.seek(endereco);
        lapide = arqCategoria.readByte();
        tamanho = arqCategoria.readShort();
        b = new byte[tamanho];
        arqCategoria.read(b);
        p.fromByteArray(b);
    }
   ...
   * @param id,alternativo Recebe o ponteiro de uma categoria em especifico
   * @return Retorna um confirmação de alteração do objeto
   */
  public boolean alterar(int id, Categoria alternativo) throws IOException
  {
    boolean resp;
    Categoria p = new Categoria();
    short tamanho;
  ...
  /**
   * Exclui um objeto do arquivo de indice e de categoria
   * @param id Recebe o ponteiro de uma categoria em especifico
  ...
  public boolean excluir(int id) throws IOException
  {
    ...
    if(endereco != -1)
    {
        ...
        for(int i = 0; i < this.list.size(); i++)
        {
          if(this.list.get(i).getidCategoria() == id)
          {
            this.list.remove(i);
            i = this.list.size();
          }//end if
  ...
  /**
   * @return Retorna uma lista de categoria que estavam no arquivo
   * @throws IOException
   */
...
class Produto
{
   ...
   */
  public Produto()
  {this(-1, -1, " ", " ", " ", " ", 0);}//end construtor padrão

  /**
   * Construtor alternativo
   * @param idProduto,idCategoria,nome,descricao,tipo,marca,preco
   * Reservam espaço para os atributos
   */
  public Produto(int idProduto, int idCategoria, String nome, String descricao,
                 String tipo, String marca, float preco)
  {
...
//------------------------------------------------------------------------------
   ...
   * @throws IOException
   */
  public static void incluir(ArquivoProdutos arqProd,
                             ArquivoCategorias arqC) throws IOException
  {
    BufferedReader br = new BufferedReader(new InputStreamReader(System.in));

    int idCategoria;
    System.out.println("Digite o id de categoria do produto: ");
    idCategoria = Integer.parseInt(br.readLine());

    while(idCategoria > 0)
    {
      Categoria cat = arqC.ler(idCategoria);
      ...
      else
      {
        ...
        System.out.println("-----------------------------------------");
        System.out.println("Digite outro id de categoria");
   ...
   * @throws IOException
   */
  public static void alterar(ArquivoProdutos arqProd,
                             ArquivoCategorias arqC) throws IOException
  {
    BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
    ...
    if(isProduto != null)
    {
      ...
      while(idCategoria > 0)
      {
        ...
        if(cat != null)
        {
          ...
          isProduto.setidCategoria(idCategoria);
   ...
   * @throws IOException
   */
  public static void consultar(ArquivoProdutos arqProd,
                               ArquivoCategorias arqC) throws IOException
  {
    BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
   ...
   * @throws IOException
   */
  public static void listar(ArquivoProdutos arqProd,
                            ArquivoCategorias arqC) throws IOException
  {
    ...
    {
      list.get(i).mostrar();
      int idCategoria = list.get(i).getidCategoria();
      Categoria cat = arqC.ler(idCategoria);
      cat.mostrar();
      System.out.println();
    }//end for
...
//------------------------------------------------------------------------------
  ...
  /**
   * Faz a inclusão de uma nova categoria
   * @param arqC
   * @throws IOException
   */
  public static void incluir(ArquivoCategorias arqC) throws IOException
  {
    BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
    ...
    //end informações da categoria-----------------------------------

             Categoria novo = new Categoria(-1, nome);

             int include = arqC.incluir(novo);

             System.out.println("Inserido com sucesso - ID: " + include);
  }//end incluir()

  /**
   * Faz a alteração de uma categoria existente
   * @param arqC
   * @throws IOException
   */
  public static void alterar(ArquivoCategorias arqC) throws IOException
  {
    BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
    ...
    Categoria isCategoria = arqC.ler(alterarID);
    ...
    if(isCategoria != null)
    {
      ...
      //informações da nova categoria---------------------------------------

               System.out.println("Digite o novo nome da categoria: ");
               nome = br.readLine();

      //end informações da nova categoria-----------------------------------

      isCategoria.setnome(nome);

      boolean alterou = arqC.alterar(alterarID, isCategoria);
  ...
  /**
   * Faz a exclusão de uma categoria existente
   * @param arqC,arqProd
   * @throws IOException
   */
  public static void excluir(ArquivoCategorias arqC,
                             ArquivoProdutos arqProd) throws IOException
  {
    BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
    ...
    boolean haveProduto = false;//verifica a existencia de algum produto com
                                //o um respectivo id da categoria

    for(int i = 0; i < list.size(); i++)
    {
      if(list.get(i).getidCategoria() != excluirID)
      {
        haveProduto = false;
      }
      else
    ...
    if(haveProduto == false)
    {
      boolean resp = arqC.excluir(excluirID);
    ...
    {
      System.out.println("Ainda existe produto nesta categoria!");
    }//end if
  }//end excluir()
   ...
   * @throws IOException
   */
  public static void consultar(ArquivoCategorias arqC) throws IOException
  {
    BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
  ...
  /**
   * Mostra a lista de categoria cadastrados
   * @param arqC
   * @throws IOException
   */
  public static void listar(ArquivoCategorias arqC) throws IOException
  {
    ArrayList<Categoria> list = arqC.listar();
...
//------------------------------------------------------------------------------
  ...
  public static void main(String []args) throws IOException
  {
    ...
    Produto p;
    ArquivoCategorias arqC;
    Categoria c;
    File rwProdutos, rwCategoria;

    try
    {
      p = new Produto();
      rwProdutos = new File("Produtos.db");
      arqProd = new ArquivoProdutos(p, "Produtos.db", "Produtos.idx");

      c = new Categoria();
      rwCategoria = new File("Categoria.db");
      arqC = new ArquivoCategorias(c, "Categoria.db", "Categoria.idx");
      ...
      System.out.println("--------Menu de Opções--------\n" +
                        ...
                        "6 - Incluir uma Categoria\n" +
                        "7 - Alterar uma Categoria\n" +
                        "8 - Excluir uma Categoria\n" +
                        "9 - Consultar uma Categoria por ID\n" +
                        "10 - Listar as Categorias\n" +
                        "0 - Sair\n" +
      ...
      while(option != 0)
      {
          switch(option)
          {
            ...
            case 5:
              ...
              option = Integer.parseInt(br.readLine());
            case 6:
              System.out.println("6 - Incluir uma categoria");
            ...
            break;
            case 7:
              System.out.println("7 - Alterar uma categoria");
            ...
            break;
            case 8:
              System.out.println("8 - Excluir uma categoria");

              excluir(arqC, arqProd);

              System.out.println("Escolha uma opção novamente!");
              option = Integer.parseInt(br.readLine());
            break;
            case 9:
              System.out.println("9 - Consultar uma categoria por ID");
            ...
            break;
              case 10:
              System.out.println("10 - Listar as categorias");
