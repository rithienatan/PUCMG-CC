 ...
 */
   ...
   // 3. testar as definicoes de arranjo
      ...
      else
      {
         ...
         {
            IO.println ( "Contato a1 nao nulo com "
               + a1.getNome( )+" e " + a1.getFone( ) );
         } // fim se
      } // fim se
      if ( a2 == null )
      {
      ...
      else
      {
         ...
         {
            IO.println ( "Contato a2 nao nulo com "
               + a2.getNome( )+" e " + a2.getFone( ) );
         } // fim se
      } // fim se      
      if ( a3 == null )
      {
 ...
 */
   ...
   // criar e executar o metodo auxiliar
      Exemplo0227 m1 = new Exemplo0227 ( );
      m1.metodo07( );
   // encerrar
      IO.pause ( "Apertar ENTER para terminar." );
   } // fim main( )
} // fim class Exemplo0227